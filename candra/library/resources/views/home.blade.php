        ...
        <div class="row">
                ...
                {{-- <div class="col-lg-6">
                        <div class="card card-primary">
                                <div class="card-header">
                                <h3 class="card-title">Grafik Keanggotaan</h3>
...
<script type="text/javascript">
        ...
        $(function(){
                ...
                // var temp0 = areaBarChartData.datasets[0]
                // var temp1 = areaBarChartData.datasets[1]

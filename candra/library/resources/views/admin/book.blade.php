        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button class="btn bg-danger" v-if="buttonAction" v-on:click="deleteData(book.id)">Delete</button>
                    <button class="btn btn-primary bg-primary" v-if="buttonAction" v-if="editStatus" v-on:click="editData(book)">Update</button>
                    <button type="submit" class="btn btn-primary" v-if="!buttonAction">Save changes</button>
                </div>
                </form>
            </div>
        <!-- /.modal-content -->

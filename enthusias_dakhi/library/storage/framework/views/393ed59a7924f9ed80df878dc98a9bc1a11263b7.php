...
<head>
  ...
  <title>Enthusias | Dashboard</title>
       ...
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="<?php echo e(url('authors')); ?>" class="nav-link <?php echo e(request()->is('authors') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravel-vue\enthusias_dakhi\library\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
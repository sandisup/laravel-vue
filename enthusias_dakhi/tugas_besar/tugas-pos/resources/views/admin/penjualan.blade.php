        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="#" @click="addData()" class="btn btn-sm btn-primary pull=right">Add New Penjualan</a>
                </div>
                <div class="card-body">
          ...
          <div class="modal-content">
            <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
              <div class="modal-header">
                ...
                <h3 class="modal-title">Penjualan</h3>
...
<script type="text/javascript">
    var actionUrl = '{{ url('penjualans') }}';
    var apiUrl = '{{ url('api/penjualans') }}';
    ...
    var columns = [
        ...
        {data: 'diterima', class: 'text-center', orderable: true},

...
Route::get('/pembelians/{pembelian}/detail', [App\Http\Controllers\PembelianController::class, 'show']);
...
Route::get('/penjualans/{penjualan}/detail', [App\Http\Controllers\PenjualanController::class, 'show']);
